    ...
    <section className="container mx-auto py-12 px-4 md:px-6">
      ...
      <div className="flex flex-col items-center text-center mb-16">
        ...
        <Button asChild size="lg" className="gap-2">
          <Link href="https://chromewebstore.google.com/detail/answerright/gnlldhbpjicjidknchpfgmacdeclcdfj"><Bot className="h-5 w-5" /> Get AnswerRight Now</Link>
          </Button>
      ...
      <div className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              <p>
                Simply upload your question by right-clicking selected text and AnswerRight will generate targeted answers
